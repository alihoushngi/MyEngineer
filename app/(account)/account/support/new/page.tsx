...
export const metadata = userAccountMetadata("تیکت جدید");
export const dynamic = "force-dynamic";

export default async function AccountNewSupportTicketRoute() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      />
      <CreateTicketForm redirectBase="/account/support" />
    </div>
  );
}
